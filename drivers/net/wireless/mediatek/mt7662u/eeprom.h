...
#ifndef __MT7662U_EEPROM_H
#define __MT7662U_EEPROM_H

struct mt7662u_dev;

#define MT7662U_EE_MAX_VER			0x0c
#define MT7662U_EEPROM_SIZE			256

#define MT7662U_DEFAULT_TX_POWER		6
...
enum mt7662u_eeprom_access_modes {
	MT_EE_READ = 0,
...
struct mt7662u_eeprom_params {
	...
	u8 chan_pwr[14];
	struct mt7662u_rate_power power_rate_table;
	s8 real_cck_bw20[2];
...
int mt7662u_eeprom_init(struct mt7662u_dev *dev);
