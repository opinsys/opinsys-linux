...
#if !defined(__MT7662U_TRACE_H) || defined(TRACE_HEADER_MULTI_READ)
#define __MT7662U_TRACE_H
...
DECLARE_EVENT_CLASS(dev_reg_evt,
	TP_PROTO(struct mt7662u_dev *dev, u32 reg, u32 val),
	TP_ARGS(dev, reg, val),
	TP_STRUCT__entry(
		DEV_ENTRY
		REG_ENTRY
...
TRACE_EVENT(mt_submit_urb,
	TP_PROTO(struct mt7662u_dev *dev, struct urb *u),
	TP_ARGS(dev, u),
	TP_STRUCT__entry(
...
TRACE_EVENT(mt_mcu_msg_send,
	TP_PROTO(struct mt7662u_dev *dev,
...
TRACE_EVENT(mt_vend_req,
	TP_PROTO(struct mt7662u_dev *dev, unsigned pipe, u8 req, u8 req_type,
...
TRACE_EVENT(ee_read,
	TP_PROTO(struct mt7662u_dev *dev, int offset, u16 val),
...
DECLARE_EVENT_CLASS(dev_rf_reg_evt,
	TP_PROTO(struct mt7662u_dev *dev, u8 bank, u8 reg, u8 val),
...
DECLARE_EVENT_CLASS(dev_bbp_reg_evt,
	TP_PROTO(struct mt7662u_dev *dev, u8 reg, u8 val),
	TP_ARGS(dev, reg, val),
	TP_STRUCT__entry(
		DEV_ENTRY
		__field(u8, reg)
...
DECLARE_EVENT_CLASS(dev_simple_evt,
	TP_PROTO(struct mt7662u_dev *dev, u8 val),
	TP_ARGS(dev, val),
	TP_STRUCT__entry(
		DEV_ENTRY
		__field(u8, val)
...
TRACE_EVENT(freq_cal_offset,
	TP_PROTO(struct mt7662u_dev *dev, u8 phy_mode, s8 freq_off),
...
TRACE_EVENT(mt_rx,
	TP_PROTO(struct mt7662u_dev *dev, struct mt7662u_rxwi *rxwi, u32 f),
	TP_ARGS(dev, rxwi, f),
	TP_STRUCT__entry(
		DEV_ENTRY
		__field_struct(struct mt7662u_rxwi, rxwi)
...
TRACE_EVENT(mt_tx,
	TP_PROTO(struct mt7662u_dev *dev, struct sk_buff *skb,
...
TRACE_EVENT(mt_tx_status_cleaned,
	TP_PROTO(struct mt7662u_dev *dev, int cleaned),
	TP_ARGS(dev, cleaned),
	TP_STRUCT__entry(
		DEV_ENTRY
		__field(int, cleaned)
...
TRACE_EVENT(mt_tx_status,
	TP_PROTO(struct mt7662u_dev *dev, u32 stat1, u32 stat2),
...
TRACE_EVENT(mt_rx_dma_aggr,
	TP_PROTO(struct mt7662u_dev *dev, int cnt, bool paged),
...
TRACE_EVENT(set_shared_key,
	TP_PROTO(struct mt7662u_dev *dev, u8 vid, u8 key),
	TP_ARGS(dev, vid, key),
	TP_STRUCT__entry(
		DEV_ENTRY
		__field(u8, vid)
